...
blackouts = np.loadtxt('{}/blackouts.txt'.format(datadir), dtype='int')
cities = np.loadtxt('{}/cities.txt'.format(datadir), dtype='int')
earthquakes = np.loadtxt('{}/earthquakes.txt'.format(datadir))
melville = np.loadtxt('{}/melville.txt'.format(datadir))
solarflares = np.loadtxt('{}/solarflares.txt'.format(datadir), dtype='int')
terrorism = np.loadtxt('{}/terrorism.txt'.format(datadir))
fires = np.loadtxt('{}/fires.txt'.format(datadir))
